...
import { FindMovieByTitleResult } from '../../application/queries/find-movie-by-title.result';

export class FindMoviesByTitleResponseDTO extends FindMovieByTitleResult {
